...
## Ejemplo 2
Para resolver el problema específico que hemos propuesto, vamos a hacer uso del paquete *snow*. Se va a mostrar la manera en la que *snow* permite facilitar la extracción homogénea de los 
